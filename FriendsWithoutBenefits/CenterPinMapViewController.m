...
- (IBAction)setLocationButtonPressed:(UIButton *)sender
{
  ...
  PFGeoPoint *geoPoint = [PFGeoPoint geoPointWithLatitude:self.selectedCoordinate.latitude longitude:self.selectedCoordinate.longitude];
  NSDictionary *userInfo = [NSDictionary dictionaryWithObject: geoPoint forKey:@"Coordinate"];
  [[NSNotificationCenter defaultCenter] postNotificationName:@"CoordinateNotification" object:self userInfo:userInfo];
