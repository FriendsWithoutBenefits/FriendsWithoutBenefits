...
- (void)queryForNearbyActivities {
  PFQuery *query = [Activity query];
}

- (IBAction)userActivitiesButtonPushed:(UIBarButtonItem *)sender {
    [self performSegueWithIdentifier:@"ShowUserActivity" sender:sender];
}

-(void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
  if ([segue.identifier isEqualToString:@"ShowUserActivity"]) {
    UserActivityFeedTableViewController *userActivityViewController = [segue destinationViewController];
  }
}
